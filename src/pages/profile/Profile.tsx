  ...
  return (
    <Box sx={{ m: -3.5, mt: -4 }}>
      ...
      <Container sx={{ mt: 8, py: 6, textAlign: 'center', maxWidth: 'lg' }}>
        <Typography variant="h3" fontWeight="bold" sx={{ mb: 2, color: '#FDEE00', letterSpacing: '1px', textAlign: 'center' }}>
          User Profile
        </Typography>
        ...
        <Grid container justifyContent="center" spacing={4}>
          <Grid item xs={12} md={4}>
            <Paper elevation={6} sx={{ p: 4, borderRadius: '12px', backgroundColor: '#ffffff', boxShadow: '0px 6px 15px rgba(0, 0, 0, 0.1)', position: 'relative' }}>
              ...
              <Typography variant="body1" color="#2A3439" sx={{ fontSize: '16px', fontWeight: '400' }}>
                email: {user.email}
              </Typography>
            </Paper>
          </Grid>
        ...
        <Divider sx={{ mt: 4, width: '60%', mx: 'auto', borderColor: '#FDEE00', borderWidth: 1 }} />

        {/* Profile Details */}
        <Box sx={{ mt: 6 }}>
          <Typography variant="h5" sx={{ color: '#fff', fontWeight: '500', textAlign: 'center', textTransform: 'uppercase' }}>
            Profile Details
          </Typography>
          <Typography variant="body1" color="info.primary" sx={{ mt: 2, fontSize: '16px', maxWidth: '800px', mx: 'auto', lineHeight: 1.8, color: '#7F8C8D' }}>
